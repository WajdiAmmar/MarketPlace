...
const { addProduct, getProductsByCategory, getProductByProduct, getAllProducts,getProductsByUser,deleteProduct } = require('../controllers/productController'); // Ajoutez getAllProducts
